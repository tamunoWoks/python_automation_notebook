...
```
**NOTE:**  
&nbsp;&nbsp;&nbsp;&nbsp;The previous example uses the triple-quote syntax (''') to create a multiline string so that you can spread the regular expression definition over many lines, making it much more legible.  
...
```
This syntax is a little old-fashioned and originates from early versions of Python. You can also pass other options for the second argument; though it's uncommon.
