...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You can pass tag values to the `str()` function to show the HTML tags they represent. Tag values also have an `attrs` attribute containing all their HTML attributes as a dictionary. For example, download the _https://autbor.com/example3.html_ page as example3.html, then enter the following:
```python
import bs4
