...
Once your Python program is finished, you might want to run it in as few keystrokes as possible. Be sure to add a *Scripts* folder to your `PATH` environment variable. Say my username is *al*, the path to this folder is *C:\Users\al\Scripts* on Windows, */Users/al/Scripts* on macOS, and */home/al/Scripts* on Linux. Also, you’ll need to set up a virtual environment for the Python scripts, as described next.
